...
class Robot():
    def __init__(self, twist_pub = "/h1/husky_velocity_controller/cmd_vel", scan_topic = " ", odom_topic = " ", imu_topic = " ", model_name = "Husky_h1", entity_name = "base_link"):
        ...
        self.lfdist_th = 4.5
        self.bdist_th = 0
        self.rfdist_crit_th = 0.2
        self.lfdist_crit_th = 0.2
        self.bdist_crit_th = 0.2
...
#   Check variables - environmental variables are controlled
    def check_distance(self,robot_1,robot_2,robot_3):
        ...
        if robot_1.x >= robot_3.x:
            ...
            self.LBV = robot_1
        self.LFV.lfdist = 100
        self.LFV.bdist =  abs(self.LFV.x- self.LBV.x) #float(math.sqrt(math.pow((self.FV.x- self.BV.x), 2) + math.pow((self.BV.y - self.FV.y), 2)))
        self.LBV.lfdist = self.LFV.bdist
        self.LBV.bdist = 100


        print("Right front distance: "+ str(robot_1.rfdist))
        print("Left front distance: "+ str(robot_1.lfdist))
    ...
    def adjust_threshold(self,robot_1,robot_2):
        ...
        robot_1.lfdist_th = robot_1.rfdist_th*2
    ...
    def check_state(self, robot_1, timestep):
        ...
        if right_check:
            ...
            if (robot_1.rfdist > robot_1.rfdist_th and robot_1.lfdist > robot_1.lfdist_th and robot_1.bdist > robot_1.bdist_th):
                ...
                self.step = 5
                if (robot_1.rfdist < robot_1.rfdist_crit_th) or (robot_1.bdist < robot_1.bdist_crit_th):
                    self.emergency = 3
            elif(robot_1.rfdist < robot_1.rfdist_th and robot_1.lfdist < robot_1.lfdist_th and robot_1.bdist > robot_1.bdist_th):
                self.step = 6
                if robot_1.rfdist < robot_1.rfdist_crit_th:
        ...
        if mid_check:
            ...
            if (robot_1.rfdist > robot_1.rfdist_th and robot_1.lfdist > robot_1.lfdist_th and robot_1.bdist > robot_1.bdist_th):
                ...
                self.step = 9
                if robot_1.bdist < robot_1.bdist_crit_th:
                    self.emergency = 2
            elif(robot_1.rfdist > robot_1.rfdist_th and robot_1.lfdist < robot_1.lfdist_th and robot_1.bdist > robot_1.bdist_th):
                self.step = 10
                ...
                self.step = 14
                if (robot_1.rfdist < robot_1.rfdist_crit_th) or (robot_1.lfdist < robot_1.lfdist_crit_th):
                    self.emergency = 3
            elif(robot_1.rfdist < robot_1.rfdist_th and robot_1.lfdist < robot_1.lfdist_th and robot_1.bdist < robot_1.bdist_th):
                self.step = 15
                if (robot_1.rfdist < robot_1.rfdist_crit_th) or (robot_1.lfdist < robot_1.lfdist_crit_th):
