...
(cl:ensure-generic-function 'old_policy-val :lambda-list '(m))
(cl:defmethod old_policy-val ((m <SelfStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader formal_control-msg:old_policy-val is deprecated.  Use formal_control-msg:old_policy instead.")
  (old_policy m))

(cl:ensure-generic-function 'v_emg-val :lambda-list '(m))
(cl:defmethod v_emg-val ((m <SelfStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader formal_control-msg:v_emg-val is deprecated.  Use formal_control-msg:v_emg instead.")
  (v_emg m))
...
(cl:defmethod emergency-val ((m <SelfStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader formal_control-msg:emergency-val is deprecated.  Use formal_control-msg:emergency instead.")
  (emergency m))

(cl:ensure-generic-function 'crit_check-val :lambda-list '(m))
(cl:defmethod crit_check-val ((m <SelfStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader formal_control-msg:crit_check-val is deprecated.  Use formal_control-msg:crit_check instead.")
  (crit_check m))

(cl:ensure-generic-function 'current_state-val :lambda-list '(m))
(cl:defmethod current_state-val ((m <SelfStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader formal_control-msg:current_state-val is deprecated.  Use formal_control-msg:current_state instead.")
  (current_state m))

(cl:ensure-generic-function 'lane-val :lambda-list '(m))
(cl:defmethod lane-val ((m <SelfStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader formal_control-msg:lane-val is deprecated.  Use formal_control-msg:lane instead.")
  (lane m))
...
(cl:defmethod request-val ((m <SelfStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader formal_control-msg:request-val is deprecated.  Use formal_control-msg:request instead.")
  (request m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SelfStateMsg>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'old_policy))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let* ((signed ele) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
   ...
   (cl:slot-value msg 'old_policy))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'v_emg))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'crit_check))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'crit_check))
  ...
  (cl:let* ((signed (cl:slot-value msg 'lane)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SelfStateMsg>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'old_policy) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'old_policy)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'v_emg) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'crit_check) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'crit_check) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'lane) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SelfStateMsg>)))
  ...
  "e16fb09f7f887b94d9bd0e0a250f07a7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SelfStateMsg)))
  "Returns md5sum for a message object of type 'SelfStateMsg"
  "e16fb09f7f887b94d9bd0e0a250f07a7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SelfStateMsg>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%float32 rfdist~%float32 lfdist~%float32 bdist~%float32 v_relative~%~%int32[] actions~%int32[] policy~%int32[] old_policy~%~%float32 v_emg~%float32 yaw_ref~%~%bool got_new_plan~%~%int32 emergency~%string crit_check~%int32 current_state~%int32 lane~%int32 timestep~%bool request~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SelfStateMsg)))
  "Returns full string definition for message of type 'SelfStateMsg"
  (cl:format cl:nil "std_msgs/Header header~%~%float32 rfdist~%float32 lfdist~%float32 bdist~%float32 v_relative~%~%int32[] actions~%int32[] policy~%int32[] old_policy~%~%float32 v_emg~%float32 yaw_ref~%~%bool got_new_plan~%~%int32 emergency~%string crit_check~%int32 current_state~%int32 lane~%int32 timestep~%bool request~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SelfStateMsg>))
  (cl:+ 0
     ...
     1
     4
     4 (cl:length (cl:slot-value msg 'crit_check))
     4
     4
     4
     1
